#We don't want to have to keep querying the API if we have searched something
#We want to be able to store search history - use that data to build better filters/apply ML to filter our data
